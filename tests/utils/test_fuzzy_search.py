...
def test_get_score__is_relevant():
    assert get_score('fiwebro', 'Firefox Web Browser') > get_score('fiwebro', 'Firefox Web SBrowser')
    assert get_score('firfo', 'Firefox Web Browser') > get_score('firfo', 'Files')
    ...
    assert get_score('', 'LibreOffice Calc') < 10
    assert get_score('0', 'LibreOffice Calc') < 10
